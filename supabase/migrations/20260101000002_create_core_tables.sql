...
-- ============================================
-- OPERATING HOURS (per facility, per day of week)
-- ============================================
...
-- ============================================
-- ICE DEPTH THRESHOLDS (per facility)
-- ============================================
...
CREATE TABLE equipment (
  ...
  facility_id UUID NOT NULL REFERENCES facilities(id) ON DELETE CASCADE,
  name TEXT NOT NULL,
  equipment_type TEXT NOT NULL, -- "compressor", "pump", "condenser", "custom"
  is_active BOOLEAN DEFAULT TRUE,
  sort_order INTEGER DEFAULT 0,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
...
-- ============================================
-- EQUIPMENT READING TYPES (admin-configurable per equipment)
-- ============================================
