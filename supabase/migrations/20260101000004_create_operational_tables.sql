-- Migration: Create operational data tables
-- Agent 01 - Step 4
...
-- ============================================
-- DAILY REPORT NOTES (per tab/type/date)
-- ============================================
...
CREATE TABLE circle_check_results (
  ...
  check_item_id UUID NOT NULL REFERENCES circle_check_items(id) ON DELETE CASCADE,
